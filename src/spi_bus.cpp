...
void init() {
    ...
    // Configure SCK and MOSI as outputs; MISO disconnected (display is write-only
    // and the flash MISO will be wired later).
    ...
    nrf::reg<std::uint32_t>(nrf::spim0::PSEL_MISO) = nrf::spim0::PSEL_DISCONNECTED;
